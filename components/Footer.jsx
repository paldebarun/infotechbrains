...
const Footer = () => {
    return (
        ...
        <div className="w-screen bg-gray-800 flex justify-center flex-col md:flex-row gap-[70px] md:gap-[80px]  px-[10px] sm:px-[30px] lg:px-[100px] py-[100px] ">
           <div className="w-full md:w-[50%]  flex   flex-col md:justify-end  gap-[40px]">
            <div className="text-white flex gap-[10px] items-center  ">
                <Image width={20} height={20} src='/images/logo.png' />
            ...
            <div>
                <Image width={200} height={200}  src='/images/foooterimage.png' />
            </div>
           </div>
           ...
           <div className="flex flex-col  justify-start items-start md:justify-end gap-[50px] lg:gap-[50px] md:gap-[30px]">
              ...
              <Image width={120} height={120} src='/images/footerimage2.png' className='' />
              <div>
               ...
               <div className="text-white sm:text-md text-[12px]">
                ...
                <div>Phone:</div> 
                <div className="text-pink-500 hover:text-slate-500 cursor-pointer">+351 930944995</div>
                </div>

                <div className="text-white flex items-center gap-[5px] sm:text-md text-[12px]">
                 <div>Email:</div> 
                <div className="text-pink-500 hover:text-slate-500 cursor-pointer">lisbon@altar.io
              ...
              <div className="flex flex-col md:flex-row gap-[20px] items-start md:items-end">
              <Image width={120} height={120} src='/images/footerimage3.png' className='' />
              <div>
               <div className="flex flex-col gap-[20px]">
               ...
               Address: 36 Wharf Road, N1 7GR
                ...
                <div className="text-white flex items-center sm:text-md text-[12px]">
                <div>Phone:</div> 
                <div className="text-pink-500 hover:text-slate-500 cursor-pointer">+44 7802685611</div>
                </div>

                <div className="text-white flex items-center gap-[5px] sm:text-md text-[12px]">
                 <div>Email:</div> 
                <div className="text-pink-500 hover:text-slate-500 cursor-pointer">london@altar.io
              ...
              <Image width={120} height={250} src='/images/footerimage4.png' className='' />
              <div>
               <div className="flex flex-col gap-[20px]">
               ...
               Address: Via orti 14, 20122
                ...
                <div className="text-white flex items-center sm:text-md text-[12px]">
                <div>Phone:</div> 
                <div className="text-pink-500 hover:text-slate-500 cursor-pointer">+39 3318853562</div>
                </div>

                <div className="text-white flex items-center gap-[5px] sm:text-md text-[12px]">
                 <div>Email:</div> 
                <div className="text-pink-500 hover:text-slate-500 cursor-pointer"> milan@altar.io
        ...
        <a href="/">
        <img src='/images/logo.png' className="w-[60px] h-[70px]" />
        </a>
        ...
        <div className="flex lg:flex-row flex-col gap-[70px] ">
            ...
            <div className="flex flex-col gap-[20px]">
                ...
                footerdata.Globaldata.map((data,index)=>(
                    <div className="text-white hover:text-gray-400  transition-colors duration-200 cursor-pointer" key={index}>{data}</div>
                ))
                }
                </div>
            ...
            <div className="flex flex-col gap-[20px]">
                ...
                footerdata.Technologydata.map((data,index)=>(
                    <div className="text-white hover:text-gray-400 cursor-pointer transition-colors duration-200" key={index}>{data}</div>
                ))
                }
                </div>
            ...
            <div className="flex flex-col gap-[20px]">
                ...
                footerdata.Buildata.map((data,index)=>(
                    <div className="text-white cursor-pointer  hover:text-gray-400 transition-colors duration-200" key={index}>{data}</div>
                ))
                }
                </div>
        ...
        <div className="w-full  px-[30px] flex flex-col  ">
            ...
            <div className="flex md:flex-row flex-col items-center gap-[20px] md:gap-0 md:justify-between py-[20px]">
                   <div className="text-gray-500 lg:inline hidden">© 2024 Altar.io all rights reserved.</div>

                   <div className="flex gap-[10px] items-center text-gray-500">
                    <div className="text-gray-500 cursor-pointer hover:text-white transition-colors duration-200 text-[10px] sm:text-md">Privacy policy</div>
                    <div className="text-[10px] sm:text-md">|</div>
                    <div className="text-gray-500 cursor-pointer hover:text-white transition-colors duration-200 text-[10px] sm:text-md">Security</div>
                    <div className="text-[10px] sm:text-md">|</div>
                    <div className="text-gray-500 cursor-pointer hover:text-white transition-colors duration-200 text-[10px] sm:text-md">Terms of services</div>
                   </div>
