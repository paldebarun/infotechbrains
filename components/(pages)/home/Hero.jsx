    ...
    return (
        ...
        >
            ...
            <div className="max-w-full relative w-full h-screen isolate">
                ...
                <div className=" ml-auto max-w-3xl px-8 pb-16 text-white pt-[18.5rem] md:pt-44">
                    <h1 className="text-5xl font-semibold md:text-5xl md:text-left text-center">
                    ...
                    <div className="mt-6 ml-auto flex gap-x-6">
                        <a
                            href="#"
                            className="my-auto text-base bg-blue-700 px-4 py-3 rounded-full font-semibold leading-6 text-gray-100"
                        >
                            Get Quotes <span aria-hidden="true">→</span>
                        </a>
                        <a
                            href="#"
                            className="my-auto text-base bg-blue-700 px-4 py-3 rounded-full font-semibold leading-6 text-gray-100"
